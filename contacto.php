...
<body>
  ...
  <br>
  <h1 class="title-about">CONTACTANOS</h1>
  <div style="padding-left: 10px; padding-right: 10px;">
    <p class="text-about">Tel-Whatsapp: 2216011694</p>
    <p class="text-about">E-mail: constructora@gmail.com</p>
    <p class="text-about">Facebook: <a href="">Click acá</a></p>
    <p class="text-about">Instagram: <a href="">Click acá</a></p>
  </div>
  <br>
  <br>
  <br>
