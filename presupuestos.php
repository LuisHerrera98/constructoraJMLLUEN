...
<body>
  ...
  <br>
  <h1 class="title-about">Solicita tu presupuesto sin cargo</h1>
  <div style="padding-left: 10px; padding-right: 10px;">
  <hr>
    <br>
    <div style="witdh:100%; display:flex; justify-content:center;">
        <a class="btn btn-primary" href="https://api.whatsapp.com/send?phone=542216011694&text=Hola%20te%20hablo%20desde%20tu%20pagina%20necesito%20un%20presupuesto%20para%20un%20trabajo%2Fobra" style="font-size:18px;">Contactanos por whatsapp</a>
    </div>
    <br>
    <br>
    <br>
